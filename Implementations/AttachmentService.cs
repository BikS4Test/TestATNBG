...
namespace ProjectName.Services
{
    public class AttachmentService : IAttachmentService
    {
        ...
        public async Task<string> UpdateAttachment(UpdateAttachmentDto request)
        {
            ...
            const string fetchSql = "SELECT * FROM Attachments WHERE Id = @Id";
            var existingAttachment = await _dbConnection.QuerySingleOrDefaultAsync<Attachment>(fetchSql, new { Id = request.Id });
        ...
        public async Task<List<Attachment>> GetListAttachment(ListAttachmentRequestDto request)
        {
            ...
            var attachments = await _dbConnection.QueryAsync<Attachment>(sql, parameters);
