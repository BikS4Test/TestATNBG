...
namespace ProjectName.Interfaces
{
    ...
    public interface IChangeLogService
    {
        ...
        /// </summary>
        /// <param name="changeLogRequestDto">The data transfer object containing the request parameters for retrieving the change log entry.</param>
        ...
        /// </summary>
        /// <param name="deleteChangeLogDto">The data transfer object containing the request parameters for deleting the change log entry.</param>
        ...
        /// </summary>
        /// <param name="listChangeLogRequestDto">The data transfer object containing the request parameters for retrieving the list of change log entries.</param>
